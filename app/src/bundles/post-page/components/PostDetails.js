...
class PostDetails extends Component {
    ...
    componentDidUpdate(prevProps) {
        if (this.props.postId !== prevProps.postId) {
            this.setState({ liked: false, shared: false, flaged: false });
        }
    }
    ...
    render() {
        ...
        if (this.state.liked) {
            like = (
                <span>
                    <img src={OnClaps} width="25" height="25" alt="OnClaps" />
                </span>
            );
        } else {
            like = (
                <span>
                    <img src={OffClaps} width="25" height="25" alt="OffClaps" />
                </span>
            );
        }
        ...
        let likeSection =
            this.props.type === 'blog_post' ? (
                <div>
                    <span class="mx-2" onClick={this.likeit.bind(this)}>
                        {like}
                    </span>
                    <span class="text-secondary">{this.props.likes}</span>
